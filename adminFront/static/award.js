...
window.addEventListener("load", async () => {
    ...
    const response = await fetch(`${rootPath}/awards/get`, {
        method: 'GET', 
        headers: {
            'Authorization': token
        }
...
// validacija i na frontendu za unose kao joi
// gui rute dodati autentifikaciju na backend
const register = async () => {
    const name = document.getElementById("name").value
    const description = document.getElementById("description").value
    const body = JSON.stringify({ name,description });
 
    const response = await fetch(`${rootPath}/awards/create`, {
        method: 'POST',
        body: body,
        headers: {
...
const deleteO = async (id) => {
    const response = await fetch(`${rootPath}/awards/delete`, {
        method: 'DELETE', 
...
const updateO = async(id) => {
    ...
    const response = await fetch(`${rootPath}/awards/update`, {
        method: 'PUT',
        body: body,
        headers: {
            'Content-Type': 'application/json',
