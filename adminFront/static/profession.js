...
window.addEventListener("load", async () => {
    ...
    const response = await fetch(`${rootPath}/professions/`, {
        method: 'GET', 
        headers: {
            'Authorization': token
        }
...
const register = async () => {
    ...
    const response = await fetch(`${rootPath}/professions/create`, {
        method: 'POST',
        body: body,
        headers: {
...
const deleteO = async (id) => {
    const response = await fetch(`${rootPath}/professions/delete`, {
        method: 'DELETE', 
...
const updateO = async(id) => {
    ...
    const response = await fetch(`${rootPath}/professions/update`, {
        method: 'PUT',
        body: body,
        headers: {
            'Content-Type': 'application/json',
